...
class Tags extends TagLib {
    protected $tags = array(
        ...
        'date'          =>      array('attr' => array('name', 'value', 'withtime'), 'close' => '0'),
    ...
    public function _date($attr, $content) {
        ...
        $withtime = empty($attr['withtime']) ? 'false' : 'true';
        ...
        $s .= '<input type="text" name="' . $attr['name'] . '" value="' . $value . '" data-withtime="' . $withtime . '" placeholder="请选择日期时间"  readonly="readonly" class="datetimepicker form-control ' . $attr['class'] . '" ' . $attrs . '/>';
        return $s;
    }
...
<div class="help-block">
    你可以直接使用 <a href="http://xiumi.us/studio/paper" target="_blank">秀米 <span class="fa fa-external-link"></span></a>, <a href="http://nc.weinc66.com/" target="_blank">微信超级编辑器 <span class="fa fa-external-link"></span></a> 等编辑工具编辑好以后将内容复制进来
</div>
DOT;
